namespace _03BarracksFactory.Core
{
    ...
    class Engine : IRunnable
    {
        ...
        private string InterpredCommand(string[] data, string commandName)
        {
            ...
            Type commandType = Type.GetType("_03BarracksFactory.Core.Commands." + commandName);
            IExecutable command = (IExecutable)Activator.CreateInstance(commandType, new object[] { data, repository, unitFactory });
